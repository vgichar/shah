    ...
    public static class Utils
    {
        ...
        static Utils()
        {
            ...
            for (int pieceTypeIndex = 0; pieceTypeIndex < Piece.TypesNo; pieceTypeIndex++)
            {
                ...
                pieceTypeToLowerCharConversion.Add(pieceTypes[pieceTypeIndex], Char.ToLowerInvariant(pieceChars[pieceTypeIndex]));
                pieceTypeToUpperCharConversion.Add(pieceTypes[pieceTypeIndex], Char.ToUpperInvariant(pieceChars[pieceTypeIndex]));
        ...
        {
            return pieceCharToTypeConversion[whiteTurn ? Char.ToUpperInvariant(type) : Char.ToLowerInvariant(type)];
        }
        ...
        /// <returns></returns>
        public static Move GetCANMove(ValilGame game, string can)
        {
        ...
        /// <param name="game">The game</param>
        /// <returns></returns>
        public static string GetSANIndex(ValilGame game)
        {
            // the game must not be null
            if (game == null) { throw new ArgumentNullException("game", Resources.NullGameMsg); }
        ...
        /// <param name="move">The move</param>
        /// <returns></returns>
        public static string GetSANEnd(ValilGame game, Move move)
        {
            // the game must not be null
            if (game == null) { throw new ArgumentNullException("game", Resources.NullGameMsg); }
