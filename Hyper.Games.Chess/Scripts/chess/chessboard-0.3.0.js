    ...
    window['ChessBoard'] = window['ChessBoard'] || function (containerElOrId, cfg) {
        ...
        function expandConfig() {
            ...
            if (cfg.hasOwnProperty('pieceTheme') !== true ||
                ...
                cfg.pieceTheme = '/Content/img/chess/{piece}.png';
            }
        ...
        */
        ...
        function buildSparePieces(color, forPromotion) {
        ...
        */
        ...
        widget.drawPromotionDialog = function () {
            if (CURRENT_ORIENTATION === 'black') {
                sparePiecesTopEl.html(buildSparePieces('black', true));
            }
            else {
                sparePiecesTopEl.html(buildSparePieces('white', true));
            }
            sparePiecesTopEl.css({ width: 224, margin: 'auto' });
        }

        widget.destroyPromotionDialog = function () {
            sparePiecesTopEl.css({ width: 'initial', margin: 'initial' });
            $("div[class^='spare-pieces']").remove();
        }
